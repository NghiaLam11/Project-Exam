<!-- -------- START ABOUT ----- -->
<div class="row p-6">
	<div class="px-lg-5 px-3 py-4">
		<div class="my-4">
			<span style="opacity: 0.5;">Trang chu /</span> Tat ca san pham
		</div>
		<div class="my-5">
			<h2>Gioi thieu</h2>
		</div>
		<p class="mt-5">
			...
			<ul>
				<li>
					 Kinh doanh xuất nhập khẩu: thời trang nam nữ, phụ kiện, quần áo, sản phẩm chuyên ngành, hàng hoá tiêu dùng và các sản phẩm hàng hoá khác. 
				</li>
				<li>
